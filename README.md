...
| **SDK-2** | in progress | Phase 2: port commands to SDK module-by-module. Done: `cnb repo view/list`, `cnb issue view/list`. Next: `cnb pr view/list`, then `label`, then writes, then `release/build/workspace` |
