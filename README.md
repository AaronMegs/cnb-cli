...
| **SDK-2** | in progress | Phase 2: port commands to SDK module-by-module. Done: `cnb repo view/list`. Next: `cnb issue/label/pr` read ops, then writes, then `release/build/workspace` |
